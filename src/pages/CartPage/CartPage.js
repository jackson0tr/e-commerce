...
const CartPage = () =>{
    ...
    const initialOptions = {
        "client-id": "AbTLwgGkSP8H3S_X4aY75V2lX33rH3vIKnix0xWHdzSWhUavhr90HyOUnQQzVbH1wDKiTLfbfAAz9rs0",
        currency: "USD",
        intent: "capture",
    };
        ...
        return(
            <div className="container my-5">
                ...
                font-manrope">
                    ...
                    <Link to="/" className="shopping-btn bg-orange text-white fw-5">Shop Now</Link>
                </div>
            </div>
        )
    }
    ...
    return(
        ...
        <div className="cart bg-whitesomke">
            <div className="container">
                <div className="cart-ctable">
                    <div className="cart-chead bg-white">
                        <div className="cart-ctr fw-6 font-manrope fs-15">
                            <div className="cart-cth">
                                <span className="cart-ctxt">List</span>
                            </div>
                            <div className="cart-cth">
                            ...
                            <div className="cart-cth">
                                <span className="ctxt">Total Price</span>
                            </div>
                            <div className="cart-cth">
